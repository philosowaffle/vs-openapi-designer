...
var languageServerDebugOptions = { execArgv: ['--nolazy', '--inspect=6009'] };
var languageClient;
...
function activate(context) {
	...
	var serverOptions = {
		...
		debug: { module: serverModule, transport: TransportKind.ipc, options: languageServerDebugOptions}
	};
	...
	var clientOptions = {
		...
		synchronize: {
			...
			fileEvents: context.workspace.createFileSystemWatcher('**/.clientrc')
		}
	};
